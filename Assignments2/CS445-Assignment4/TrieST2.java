/* CS 0445 Spring 2024
   This is a modification of the TrieST class from the Sedgewick
   CS 1501 textbook. Recall that we have been utilizing data
   abstraction throughout this term. You will need to utilize
   this class in Assignment 4 but you do not need know its
   implementation details. The key methods you will need are
   commented below. 
   
   See also handout TrieSTTest.java to see how this is utilized.
   
   Note: You may discuss tries and their implementation in
   another course.
*/
