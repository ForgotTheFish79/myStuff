...
public static void TestBuses()
{
	...
	BusRoute routeB = new BusRoute(71, "Connects Oakland with Downtown.",
	stopB, stopA);
	...
	// Bus with identifier KLJF3, driver named Molly, average speed of 22mph, on the 61 route
	...
	stopA.getPassengersWaiting() + " passengers waiting at the " + stopA.getStopName()
	+ " stop.");
	//Load the buses
	...
	System.out.println("Bus " + busA.getBusIdentifier() + " took " +
	busA.moveToNextStop() + " minutes to reach " + busA.currentStop.getStopName());
	System.out.println("Bus " + busB.getBusIdentifier() + " took " +
	busB.moveToNextStop() + " minutes to reach " + busB.currentStop.getStopName());
	System.out.println("\n================================\n");
...
public static void TestMetro()
	...
	MetroRoute routeB = new MetroRoute(103, "Connects Downtown and theNorth Shore", stationC, stationA);
	//Use toStrings to describe these routes
	System.out.println(routeA);
	System.out.println(routeA.firstStop);
	System.out.println(routeA.lastStop);
	...
	// Train with identifier IOPS2, conductor named Eli, average speed of20 mph, 3 train cars, on the 102 route
	...
	System.out.println("There are currently " +
	stationA.getPassengersWaiting() + " passengers waiting at the " +
	stationA.getStationName() + " station.");
	//Load the trains
	...
	System.out.println("There are currently " +
	stationA.getPassengersWaiting() + " passengers waiting at the " +
	stationA.getStationName() + " stop.");
	System.out.println("\n================================\n");
	System.out.println("The trains will ride to their next stops!\n");
	System.out.println("Train " + trainA.getTrainIdentifier() + " took " +
	trainA.moveToNextStation() + " minutes to reach " +
	trainA.currentStation.getStationName());
	System.out.println("Bus " + trainB.getTrainIdentifier() + " took " +
	trainB.moveToNextStation() + " minutes to reach " +
	trainB.currentStation.getStationName());
	System.out.println("\n================================\n");
	...
	System.out.println(trainA);
	//Move one more time
	System.out.println("Bus " + trainA.getTrainIdentifier() + " took " +
	trainA.moveToNextStation() + " minutes to reach " +
	trainA.currentStation.getStationName());
	System.out.println("\n================================\n");
